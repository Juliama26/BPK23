...
export default function TeknologiAdd() {
  ...
  const createTeknologi = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post("http://localhost:5000/Teknologi", {
        nama,
        namalain,
        provinsi,
        kota,
  ...
  return (
    <div className="font-romans text-secondary py-3 px-2">
      ...
      <div>
        <form onSubmit={createTeknologi} className="w-full mb-10">
