...
export default function BahasaAdd() {
  ...
  const createBahasa = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post("http://localhost:5000/Bahasa", {
        nama,
        namalain,
        provinsi,
        kota,
  ...
  return (
    <div className="font-romans text-secondary py-3 px-2">
      ...
      <div>
        <form onSubmit={createBahasa} className="w-full mb-10">
