...
export default function OlahragaAdd() {
  ...
  const createOlahraga = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post("http://localhost:5000/Olahraga", {
        nama,
        namalain,
        provinsi,
        kota,
  ...
  return (
    <div className="font-romans text-secondary py-3 px-2">
      ...
      <div>
        <form onSubmit={createOlahraga} className="w-full mb-10">
